-- Latihan SQL (1): Membuat tabel Employee
...
-- Latihan SQL (2): Menampilkan data yang telah di-INSERT
SELECT * FROM Employee;
...
-- Latihan SQL (6): Menampilkan data dengan nama 'Budi' dan usia di atas 21 tahun
...
-- Latihan SQL (8): Menggunakan SELECT untuk menambahkan data dari tabel lain
INSERT INTO Employee (id_emp, name_emp, age)
